...
//salva o resultado da matrix em um arquivo txt, result_random_matrix.txt
void save_matrix(){
    FILE *file_output;
    file_output = fopen("result_random_matrix.txt", "w");
    ...
    printf("Você pode encontrá-la em: result_random_matrix.txt\n");
    fclose(file_output);
