...
class finite_diff_heat_problem:
    ...
    def __init__(self,node,t_0,t_n,x_0,x_n,h_conv,d,k):
        self.p = np.pi * d
        self.a = (np.pi*d*d) / 4
        self.m = (h_conv*self.p) / (k*self.a)
        self.h = (x_n - x_0) / node
        self.Q = 2 + (self.m*self.h*self.h)
        self.W = 20*self.m*self.h*self.h
        self.t_0 = t_0
        self.t_n = t_n
        self.x_0 = x_0
        self.x_n = x_n
...
heat_problem = finite_diff_heat_problem(node,t_0,t_n,x_0,x_n,h_conv,d,k)
