...
class GreatCircle(object):
    ...
    def __init__(self,addressTuple1,addressTuple2):

        """
        Create a set of attributes with default values.
        """

        self.name1 =  addressTuple1[0]
        self.latitude1_degrees = addressTuple1[1]
        self.longitude1_degrees = addressTuple1[2]
        self.latitude1_radians = 0
        self.longitude1_radians = 0

        self.name2 = addressTuple2[0]
        self.latitude2_degrees = addressTuple2[1]
        self.longitude2_degrees = addressTuple2[2]
